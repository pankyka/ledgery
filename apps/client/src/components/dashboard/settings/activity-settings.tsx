    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>A szervezethez tartozó összes felhasználói tevékenység nyomon követése</CardDescription>
        </CardHeader>
        <CardContent>
          <Table>
            <TableHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Testreszabhatja, hogy milyen tevékenységeket szeretne látni</CardDescription>
        </CardHeader>
        <CardContent>
